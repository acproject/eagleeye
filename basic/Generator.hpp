...
{
	return T(double(rand()) / double(RAND_MAX) * double(m_high - m_low) + double(m_low));
}
//////////////////////////////////////////////////////////////////////////
...
//////////////////////////////////////////////////////////////////////////
template<typename T>
GaussianGenerator<T>::GaussianGenerator(double mean_val,double variance_val,UniformGenerator<double>* u1,UniformGenerator<double>* u2)
{
	m_mean_val = mean_val;
